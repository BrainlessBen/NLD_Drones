...
//Drone1 settings
#define Drone1_MaxSpeed 40
#define Drone1_FuelCap 5
#define Drone1_LiftForce 8
#define Drone1_StartDuration 0.5
#define Drone1_BodyFriction 0.3
#define Drone1_AltFullForce 250
#define Drone1_AltNoForce 500
#define Drone1_SteerAheadSimul 0.2
#define Drone1_SteerAheadPlan 0.4
#define Drone1_PredictTurnSimul 0.5
#define Drone1_PreductTurnPlan 0.5
#define Drone1_CyclicAsideForce 0.3
#define Drone1_CyclicForwardForce 0.2
#define Drone1_BackRotorForce 0.5
...
#define Drone2_SteerAheadPlan 0.7
...
#define Drone2_BackRotorForce 2
